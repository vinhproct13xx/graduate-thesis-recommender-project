        ...
        <div class="row">
                ...
                <div class="card sidebar-menu mb-4">
                    ...
                    <div class="card-body">
                        <ul class="nav nav-pills flex-column">
                            ...
                            <a href="{{route('admin.list_admin_get')}}" class="nav-link active"><i class="fa fa-user"></i> Tài khoản admin</a></li>
            ...
            <div class="col-lg-9">
                <div class="box">
                    ...
                    <hr>
                    <form action="{{route('admin.add_admin')}}" enctype="multipart/form-data"  method="get">
                        {{----}}
                        {{ csrf_field() }}
                    <div class="row">
                        {{--<div class="col-md-4">--}}
                        ...
                        <div class="col-md-12 text-left">
                            <button id="submit" name="submit" onclick="{{route('admin.add_admin')}}" value="Submit" class="btn btn-primary">
                                ...
                                @if(isset($cus_list))
                                    @foreach($cus_list as $item)
                                        <tr>
                                            ...
                                            <td>{{$item['Email']}}</td>
                                            <td class="BtnEdit">
                                                <a class ="btn btn-primary btn-sm" href="{{route('admin.detail_admin',$item['Id'])}}">
                                                    Sửa
                                                </a>
                                            </td>
                                            <td class="BtnDelete">
                                                <a class ="btn btn-primary btn-sm" href="{{route('admin.delete_admin',$item['Id'])}}">
                                                    Xóa
                                                </a>
                                            </td>
                                        </tr>
