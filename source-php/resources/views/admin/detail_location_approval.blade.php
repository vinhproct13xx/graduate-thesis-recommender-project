        ...
        <div class="row">
            ...
            <div class="col-lg-9">
                <div id="product" class="box">
                    <h1>Duyệt thông tin nhà hàng</h1>
                    <hr>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div>
                                    <label for="Id">Mã nhà hàng</label>
                                    <input id="Id" name="Id" type="text" value="{{$location['Id']}}" readonly="true" class="form-control">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div>
                            ...
                            <div class="col-md-12">
                                <div>
                                    <label for="AddressMap">Tọa độ nhà hàng</label>
                                </div>
                            </div>
                            <div class="col-md-12" >
                            ...
                            <div class="col-md-6 text-right">
                                <button id="Submit" name="Submit" value="Submit" class="btn btn-primary">
                                    <i class="fa fa-save	"></i> Duyệt

                                </button>
                            </div>
                            <div class="col-md-6 text-left">
                                <button id="Disapproval" name="Disapproval" value="Submit" class="btn btn-primary">
                                    <i class="fa fa-close	"></i> Từ chối
    ...
    <script>
        $(document).ready(function (){
            $('#Submit').click(function () {
                ...
                console.log($('#list_location').attr('api-approve'));
                var Id = $('#ID').val();
                var Name = $('#Name').val();
                ...
                var CloseMinute = $('#CloseMinute').val();
                var MinPrice = $('#MinPrice').val();
                var MaxPrice = $('#MaxPrice').val();
                $.ajax({
                    url: $('#list_location').attr('api-approve'),
                    type: 'POST',
                    async: true,
                    data: {
                        "Id": Id,
                    ...
                    window.location.href = $('#list_location').attr('api_reload');
                }).fail(function (){
                    console.log('FAIL');
                });
            })
            $('#Disapproval').click(function () {
                ...
                // let id_product = objective.find("District").val();
                // console.log(id_product);
                console.log($('#list_location').attr('api-disapprove'));
                $.ajax({
                    url: $('#list_location').attr('api-disapprove'),
                    type: 'GET',
                    async: true,
                    data: {
